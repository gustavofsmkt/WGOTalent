      ...
      .values([
        {
          ...
          cargoInteresse: cargoDevSenior.titulo,
          areaInteresse: depTI.nome,
        ...
        },
        {
          ...
          possuiVeiculo: false,
          ensinoMedioConcluido: true,
          cargoInteresse: cargoDevops.titulo,
          areaInteresse: depTI.nome,
        ...
        },
        {
          ...
          possuiVeiculo: true,
          ensinoMedioConcluido: true,
          cargoInteresse: cargoAnalistaRH.titulo,
          areaInteresse: depRH.nome,
          disponivelViagens: true,
          disponivelMudanca: true,
        ...
        },
        {
          ...
          possuiVeiculo: true,
          ensinoMedioConcluido: true,
          cargoInteresse: cargoExecutivoVendas.titulo,
          areaInteresse: depComercial.nome,
          disponivelViagens: true,
          disponivelMudanca: false,
        ...
        },
        {
          ...
          possuiVeiculo: true,
          ensinoMedioConcluido: true,
          cargoInteresse: cargoCoordLogistica.titulo,
          areaInteresse: depOperacoes.nome,
          disponivelViagens: false,
          disponivelMudanca: false,

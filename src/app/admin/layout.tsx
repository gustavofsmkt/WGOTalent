// TODO(RBAC): ativar quando o sistema de autenticação/perfis existir.
// Verificar aqui se o usuário logado tem role === "admin" antes de renderizar
// este layout; redirecionar (ex. via `redirect()` do next/navigation) caso não
// tenha. Ver ADR pendente de autenticação (ainda não criada).

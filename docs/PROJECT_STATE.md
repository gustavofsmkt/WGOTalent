...
Triagem de IA executada nativamente pela plataforma via motor de agentes
configurável (ver ADR-0007). As etapas dos fluxos `candidato_vagas` e
`vaga_candidatos` possuem histórico persistente de sucesso/falha e retry manual

...
- **Autenticação Local**: Login obrigatório, sessão stateless em cookie assinado, gestão de usuários e troca/redefinição de senha (ver ADR-0012).

## Fora de Escopo (MVP)

- Perfis de acesso e autorização granular (todos os usuários autenticados têm as mesmas capacidades).
